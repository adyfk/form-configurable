...
exports.initializeSchema = exports["default"] = void 0;
...
var executeEachConfig = function executeEachConfig(schema, data, extraData) {
...
var initializeSchema = function initializeSchema(schema, data, extraData) {
  var overrideSchema = (0, _toConsumableArray2["default"])(schema);
  executeEachConfig(overrideSchema, data, extraData || {});
  return overrideSchema;
};
exports.initializeSchema = initializeSchema;
var _default = initializeSchema;
